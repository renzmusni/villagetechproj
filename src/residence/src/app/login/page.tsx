...
import { Home, Eye, EyeOff, Mail, Lock, Shield } from 'lucide-react'
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sign in to your residence portal
          </p>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <div className="space-y-2">
                    <div>
                      <p className="font-medium">Household Head:</p>
                      <p>Email: emily.chen@residence.com</p>
                      <p>Password: demo123</p>
                    </div>
                    <div>
                      <p className="font-medium">Household Member:</p>
                      <p>Email: resident@demo.com</p>
                      <p>Password: demo123</p>
                    </div>
                    <div>
                      <p className="font-medium">Security Head:</p>
                      <p>Email: security@sunnymeadows.com</p>
                      <p>Password: demo123</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="text-center text-sm text-gray-600">
          <p>Need help? Contact your community administrator</p>
        </div>
      </div>
    </div>
  )
