-- Simple HOA Database Setup - Run this first!
...
CREATE POLICY "Enable update for authenticated users" ON announcements FOR UPDATE WITH CHECK (true);
CREATE POLICY "Enable delete for authenticated users" ON announcements FOR DELETE WITH CHECK (true);

print('✅ Database setup completed successfully!');
print('📊 Tables created: communities, users, announcements');
print('👥 Sample users inserted with password: demo123');
